...
export class ServicioComponent implements OnInit {
  ...
  crearServicio(): void {
    this.http.get<any[]>(`http://localhost/TuPatinetaV2/API_Tupatineta/API_Tupatineta.php/servicio?id_usuario=${this.id_usuario}`)
    .subscribe(
      servicios => {
  ...
  cargar_datos(id_servicio: number): void {
    ...
    this.http.get<any>(`http://localhost/TuPatinetaV2/API_Tupatineta/API_Tupatineta.php/serviciosbyid?id=${id_servicio}`)
      .subscribe(
        servicio => {
          console.log(servicio.id_tipo_servicio);
